...
//  EazelIOS
//
//  Created by Pumpkin-SweetPotato on 2020/04/03.
...
@available(iOS 13.0, *)
public class RxAppleSignInDelegateProxy: DelegateProxy<ASAuthorizationController, ASAuthorizationControllerDelegate>, DelegateProxyType, ASAuthorizationControllerDelegate {
